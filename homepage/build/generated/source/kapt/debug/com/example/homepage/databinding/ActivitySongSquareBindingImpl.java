...
public class ActivitySongSquareBindingImpl extends ActivitySongSquareBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_bar, 4);
        sViewsWithIds.put(R.id.guideline2, 5);
        sViewsWithIds.put(R.id.vp_tab_square, 6);
        sViewsWithIds.put(R.id.bottom_nav, 7);
    }
    // views
    @NonNull
    ...
    public ActivitySongSquareBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActivitySongSquareBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (com.google.android.material.bottomnavigation.BottomNavigationView) bindings[7]
            , (androidx.constraintlayout.widget.Guideline) bindings[5]
            , (com.example.homepage.widget.TextBar) bindings[4]
            , (android.view.View) bindings[3]
            , (com.example.common.baseui.assembly.BaseViewPage) bindings[6]
            );
