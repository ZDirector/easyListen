...
public final class HrMusic {
    ...
    private final int volumeDelta = 0;
    
    @org.jetbrains.annotations.NotNull
    public final com.example.homepage.toplist.bean.HrMusic copy(int bitrate, int dfsId, @org.jetbrains.annotations.NotNull
    java.lang.String extension, long id, @org.jetbrains.annotations.NotNull
    java.lang.Object name, int playTime, int size, int sr, int volumeDelta) {
        return null;
    }
    ...
    public HrMusic(int bitrate, int dfsId, @org.jetbrains.annotations.NotNull
    java.lang.String extension, long id, @org.jetbrains.annotations.NotNull
    java.lang.Object name, int playTime, int size, int sr, int volumeDelta) {
        super();
    }
