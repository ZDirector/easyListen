...
class MusicResultListAdapter(var musicResultList : MutableList<Song> ) : RecyclerView.Adapter<MusicResultListAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(view : View) : RecyclerView.ViewHolder(view){
        ...
        val itemSearchMusicLabelAudition : TextView = view.findViewById(R.id.item_search_music_label_audition)
        val itemSearchMusicLabelOriginal : TextView = view.findViewById(R.id.item_search_music_label_original)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_search_music_list,parent,false)
